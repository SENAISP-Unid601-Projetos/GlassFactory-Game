...
const FornoLogica = {
    ...
    selecionarMistura: function(tipoMistura) {
        ...
        document.querySelectorAll('.item-selecao[data-mistura]').forEach(item => {
            item.classList.remove('selecionado');
            const dataMistura = item.dataset.mistura;
            const quantidade = SistemaInventario.obterQuantidade(dataMistura);
        ...
        const elementoSelecionado = document.querySelector(`[data-mistura="${tipoMistura}"]`);
...
const ISLogica = {
    ...
    selecionarVidro: function(tipoVidro) {
        ...
        document.querySelectorAll('.item-selecao[data-vidro]').forEach(item => {
            item.classList.remove('selecionado');
            const dataVidro = item.dataset.vidro;
            const quantidade = SistemaInventario.obterQuantidade(dataVidro);
        ...
        // Adicionar seleção ao item clicado
        const elementoSelecionado = document.querySelector(`[data-vidro="${tipoVidro}"]`);
        if (elementoSelecionado) {
            elementoSelecionado.classList.add('selecionado');
        }
...
const ScannerLogica = {
    ...
    selecionarProduto: function(tipoProduto) {
        ...
        document.querySelectorAll('.item-selecao[data-produto]').forEach(item => {
            item.classList.remove('selecionado');
            const dataProduto = item.dataset.produto;
            const quantidade = SistemaInventario.obterQuantidade(dataProduto);
        ...
        // Adicionar seleção ao item clicado
        const elementoSelecionado = document.querySelector(`[data-produto="${tipoProduto}"]`);
        if (elementoSelecionado) {
            elementoSelecionado.classList.add('selecionado');
        }
